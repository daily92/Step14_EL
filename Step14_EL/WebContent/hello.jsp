...
<body>
	...
	<p> 10 은 2 보다 커요 : <strong>${10 gt 2 }</strong></p> <%-- great --%>
	<p> 10 은 2 와 같거나 커요 : <strong>${10 >= 2}</strong></p>
	<p> 10 은 2 와 같거나 커요 : <strong>${10 ge 2}</strong></p> <%-- great | equal --%>
	<p> 10 은 2 보다 작아요 : <strong>${10 < 2 }</strong></p>
	<p> 10 은 2 보다 작아요 : <strong>${10 lt 2 }</strong></p> <%-- little --%>
	<p> 10 은 2 와 같거나 작아요 : <strong>${10 <= 2 }</strong></p>
	<p> 10 은 2 와 같거나 작아요 : <strong>${10 le 2 }</strong></p> <%-- little | equal --%>
	<p> 10 과 10은 같아요 : <strong>${10 == 10 }</strong></p>
	<p> 10 과 10은 같아요 : <strong>${10 eq 10 }</strong></p> <%-- equal --%>
	...
	<%-- empty/not empty 뒤의 값이 비었으면 => true, 안 비었으면 => false 반환 
		여기서 null 또는 "" 값을 넣으면 empty => true / not empty => not true --%>
